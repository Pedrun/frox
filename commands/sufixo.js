  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(subCommand =>
      ...
      .addStringOption(option =>
        option.setName("separador")
        .setDescription('O que separa o seu nick do sufixo. Ele não pode repetir em seu nick. Ex: "[" em "João [HP:9 MP:7]"')
        .setRequired(true)
      )
      .addStringOption(option =>
        option.setName("sufixo")
        .setDescription('O sufixo em si. Atributos envoltos por "{}" serão trocador pelo seu valor. Ex: "HP:{HP} MP:{MP}"')
        .setRequired(true)
      )
    )
    .addSubcommand(subCommand =>
      subCommand.setName("desligar")
      .setDescription("Desliga o sufixo")
    )
  ,
  /**
   * 
  ...
  execute(interaction, client) {
    ...
    switch(subCommand) {
      case 'editar': {
        ...
        const suffix = interaction.options.getString("sufixo");
